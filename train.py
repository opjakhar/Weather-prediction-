...
parser.add_argument("--model_save", type=str,dest="abc3")
parser.add_argument("--dropout_prob", type=float,dest="abc4")
parser.add_argument("--beam_width",type=int,dest="abc5")
data_field= parser.parse_args()

learning_rate=data_field.abc
print(learning_rate)
batch_size = data_field.abc1    
print(batch_size)
intit = data_field.abc2
print(intit)
model_name=data_field.abc3
print(model_name)
dropout_prob=data_field.abc4
print(dropout_prob)
beam_width=data_field.abc5
print(beam_width)
...
def combined_data_encoding(input_data, hidden_size, num_layers,
    ...
    if flag_1 == True :
        ...
        print("hello0-------------working")
        print(encoder_forward_outputs)
        print(encoder_backward_outputs)
        print('\n')
        print(encoder_forward_final_state)
#print('\n')
        print(encoder_backward_final_state)
#	print("checking ennds---------")
    ...
    print("printing encoder state")
    print(encoder_state[-1].h)    
    if flag_2 == True :
...
with tf.Session(graph=training_graph) as sess:
    ...
    for epoch_number in range(0, epochs):
        ...
        if val_loss_batch>prev_loss:
            early_stop=early_stop-1
            prev_loss=val_loss_batch
